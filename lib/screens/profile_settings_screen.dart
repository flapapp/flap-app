          ...
          : ListView(
              ...
              children: [
                _buildSectionTitle(
                  ...
                  I18n.inline('Керуйте базовими параметрами профілю', 'Manage basic profile preferences'),
                ),
                const SizedBox(height: 12),
                _buildSwitchTile(
                  title: I18n.inline('Увімкнути сповіщення', 'Enable notifications'),
                  subtitle: I18n.inline('Отримувати системні та соціальні сповіщення', 'Receive system and social notifications'),
                  value: _notificationsEnabled,
                  onChanged: (value) => setState(() => _notificationsEnabled = value),
                ),
                _buildSwitchTile(
                  title: I18n.inline('Автовідтворення відео', 'Autoplay videos'),
                  subtitle: I18n.inline('Автоматично запускати відео на екранах перегляду', 'Automatically start videos on viewing screens'),
                  value: _autoplayVideos,
                  onChanged: (value) => setState(() => _autoplayVideos = value),
                ),
                _buildSwitchTile(
                  title: I18n.inline('Показувати онлайн-статус', 'Show online status'),
                  subtitle: I18n.inline('Дозволити іншим бачити вашу активність', 'Allow others to see your activity'),
                  value: _showOnlineStatus,
                  onChanged: (value) => setState(() => _showOnlineStatus = value),
                ),
                _buildSwitchTile(
                  title: I18n.inline('Дозволити запити в друзі', 'Allow friend requests'),
                  subtitle: I18n.inline('Інші гравці зможуть надсилати запити', 'Other players will be able to send requests'),
